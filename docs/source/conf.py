'''
EGES documentation build configuration file
'''
...
intersphinx_mapping = {
    ...
    "forking_page": ("https://cisecurity-rtd-forking-page.readthedocs-hosted.com/en/latest/", None),
    ...
    "essential_guide": ("https://essentialguide.docs.cisecurity.org/en/latest/", None),
}
...
html_title = 'Essential Guide to Election Security'
