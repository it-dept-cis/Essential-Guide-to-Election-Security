...
As a follow-on to The Handbook for Election Infrastructure Security, the _`Center for Internet Security <https://cisecurity.org>` (CIS) has developed the Essential Guide to Election Security to serve as a first-stop resource for election officials to learn about best practices in election security. This can aid the process of building a program designed to meet individual needs and abilities of any given election office.
