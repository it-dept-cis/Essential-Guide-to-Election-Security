...
#. Implement a `CIS Benchmark <https://www.cisecurity.org/cis-benchmarks/>`_ for firewall management.

Cost-Effective Tools
**********************************************

*  Free vulnerability scanning from CISA (contact |CISA_vuln_email| with subject line "Requesting Cyber Hygiene Services")
*  CIS Benchmarks for firewall management (https://www.cisecurity.org/cis-benchmarks/)
