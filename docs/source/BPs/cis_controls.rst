...
Within each of the 18 CIS Controls is a set of safeguards focused on a specific security function. There are a total of **XXX** safeguards.

The CIS Controls are organized into three Implementation Groups (IGs). The maturities in this guide are loosely based on those IGs:
