...
1.  Download and complete the six simple :doc:`IT inventory worksheets <../Appendices/worksheets.rst#testing>`. Together, these fulfill the :doc:`Asset Management <../BPs/asset_management>` best practice for |Maturity1|.
