...
1.  Complete the six simple :doc:`IT inventory worksheets <../appendices/worksheets.rst#IT-Inventory-Worksheets>`. Together, these fulfill the :doc:`Asset Management <../BPs/asset_management>` best practice for |Maturity1|.
